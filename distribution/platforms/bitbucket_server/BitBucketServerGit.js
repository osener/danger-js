...
var os_1 = require("os");
var d = debug("danger:BitBucketServerGit");
/**
...
var bitBucketServerDiffToGitStructuredDiff = function (diffs) {
    return diffs.map(function (diff) { return ({
        ...
        chunks: diff.hunks.map(function (hunk) { return ({
            changes: hunk.segments.map(function (segment) { return ({
                type: segment.type === "ADDED" ? "add" : "del",
                content: segment.lines.map(function (_a) {
                    var line = _a.line;
                    return line;
                }).join(os_1.EOL),
            }); }),
