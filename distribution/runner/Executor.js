...
var Executor = /** @class */ (function () {
     ...
     */
    Executor.prototype.handleResultsPostingToPlatform = function (results, git) {
        return __awaiter(this, void 0, void 0, function () {
            var fails, warnings, messages, markdowns, failureCount, messageCount, dangerID, failed, successPosting, previousComments, _i, previousComments_1, comment, s, are, previousComments, inline, inlineLeftovers, regular, mergedResults, comment;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fails = results.fails, warnings = results.warnings, messages = results.messages, markdowns = results.markdowns;
                    ...
                    case 1:
                        ...
                        if (!(failureCount + messageCount === 0)) return [3 /*break*/, 8];
                    ...
                    case 3:
                        ...
                        _a.label = 4;
                    case 4:
                        if (!(_i < previousComments_1.length)) return [3 /*break*/, 7];
                    ...
                    case 11:
                        ...
                        _a.label = 12;
                    case 12:
                        if (!this.options.verbose) return [3 /*break*/, 14];
                        return [4 /*yield*/, this.handleResultsPostingToSTDOUT(results)];
                    case 13:
                        _a.sent();
                        _a.label = 14;
    ...
    Executor.prototype.sendInlineComments = function (results, git, previousComments) {
        ...
        var deleteComments = previousComments.filter(function (c) { return c.ownedByDanger; });
        var commentPromises = [];
    ...
    Executor.prototype.inlineCommentTemplate = function (inlineResults) {
        ...
        var comment = process.env["DANGER_BITBUCKETSERVER_HOST"]
            ? bitbucketServerTemplate_1.inlineTemplate(results)
